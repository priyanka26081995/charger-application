...
if(!isset($_SESSION['sk_razorpay_order_id'])  &&  !isset($_SESSION['sk_razorpay_id']) &&  !isset($_SESSION['sk_razorpay_amount']))      
{
...
$razorpay_signature = "";
$razorpay_payment_id = "";
$razorpay_order_id = $_SESSION['sk_razorpay_order_id'];
$razorpay_id = $_SESSION['sk_razorpay_id'];
$razorpay_amount = $_SESSION['sk_razorpay_amount'];
// var_dump($_SESSION);
// var_dump($_REQUEST);
// // die();
