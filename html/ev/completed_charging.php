...
require_once('../dist/lib/functions.php'); 
 ...
 <div class="row">
			 ...
			 <div class="col-4 p-1">
                <button class="btn  btn-block btn-success  sk-rounded "    >Completed</button>
			</div>
			 <div class="col-4 p-1">
...
where bb.user_pk = ".$login_eviot_user_id." and  bb.is_active =  ".ACTIVE_FLAG." 
				...
				<div class="row  ">
				  ...
				  <div class="col-9"> 
					<div class="row  ">
					  ...
					  <div class="col-12">
						<div class="form-group    "> 
						  <span class="sk-left">Amount : </span><span class="sk-right">Rs.<?=$charging_booking['charging_final_amount']?></span>
						</div>    
					</div>    
					  <div class="col-12">
						<div class="form-group    "> 
						  <span class="sk-left">Energy Used : </span><span class="sk-right"><?=$charging_booking['charging_final_unit']?>kW</span>
						</div>    
					</div>   
					  <div class="col-12">
						<div class="form-group    "> 
				 ...
				 <div class="col-12">
					<a class="btn  btn-block btn-info   " href="invoice.php?id=<?php echo $charging_booking_pk; ?>"  >Invoice Details </a>
				</div> 
				 <div class="col-6" style="display:none">
					<button class="btn  btn-block btn-warning  "   >Mail Invoice </button>
				</div>  
				<!-- /.row -->
	...
	<div class="row  ">
	  <div class="col-12 sk-text-center  mt-5">
		<div class="form-group  sk-inline mt-5">
			<h3>No completed charging data available</h3>
		</div>  
	</div>  
</div>  
	<?php
