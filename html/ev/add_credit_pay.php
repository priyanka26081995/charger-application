...
setcookie(COOKIE_RAZORPAY_ORDER_ID, $_SESSION['sk_razorpay_order_id'],  time()+86400);
$_COOKIE[COOKIE_RAZORPAY_ORDER_ID] = $_SESSION['sk_razorpay_order_id'];
setcookie(COOKIE_RAZORPAY_ID, $_SESSION['sk_razorpay_id'],  time()+86400);
$_COOKIE[COOKIE_RAZORPAY_ID] = $_SESSION['sk_razorpay_id'];
setcookie(COOKIE_RAZORPAY_AMOUNT, $_SESSION['sk_razorpay_amount'],  time()+86400);
$_COOKIE[COOKIE_RAZORPAY_AMOUNT] = $_SESSION['sk_razorpay_amount'];
setcookie(COOKIE_RAZORPAY_PREFILL_NAME, $login_eviot_user_name ,  time()+86400);
$_COOKIE[COOKIE_RAZORPAY_PREFILL_NAME] = $login_eviot_user_name;
setcookie(COOKIE_RAZORPAY_PREFILL_EMAIL, $login_eviot_user_email ,  time()+86400);
$_COOKIE[COOKIE_RAZORPAY_PREFILL_EMAIL] = $login_eviot_user_email;
setcookie(COOKIE_RAZORPAY_PREFILL_MOBILE, $login_eviot_user_mobile ,  time()+86400);
$_COOKIE[COOKIE_RAZORPAY_PREFILL_MOBILE] = $login_eviot_user_mobile;
//exit();
