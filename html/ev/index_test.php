...
$data_array = array();
$sql = "Select  c.charge_box_pk ,c.charge_point_vendor, c.charge_box_id   , c.charge_point_vendor  , 
...
beachFlagImg.src =
  ...
  title: markerInfo.charge_point_vendor,
				...
				beachFlagMarkerView.addListener('click', function () {
					// Alert when marker is clicked
					GotoBooking(beachFlagMarkerView.charge_box_pk, beachFlagMarkerView.charge_box_id, beachFlagMarkerView.charge_point_vendor)
				});
